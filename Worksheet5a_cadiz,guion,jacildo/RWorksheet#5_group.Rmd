...
```{r}
# Function to rank products by price and ratings
rank_products <- function(data, category_name) {
  cat("Ranking for", category_name, "Category\n\n")
  
  # Sort by Price
  price_ranked <- data[order(as.numeric(data$Prices_amazon), decreasing = TRUE, na.last = TRUE), ]
  cat("Top 5 Products by Price:\n")
  print(head(price_ranked[, c("Descriptions_amazon", "Prices_amazon", "Ratings_amazon")], 5))
  
  # Sort by Ratings
  rating_ranked <- data[order(as.numeric(data$Ratings_amazon), decreasing = TRUE, na.last = TRUE), ]
  cat("\nTop 5 Products by Ratings:\n")
  print(head(rating_ranked[, c("Descriptions_amazon", "Prices_amazon", "Ratings_amazon")], 5))
  
  cat("\n============================\n\n")
}

# Rank products for each category
rank_products(amazondf1, "MakeUp")
rank_products(amazondf2, "SkinCare")
rank_products(amazondf3, "HairCare")
rank_products(amazondf4, "Fragrance")
rank_products(amazondf5, "OralCare")
