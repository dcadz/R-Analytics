...
# Guion
Each data frame corresponds to each category namely; makeup, skincare, 
hair care, fragrance, and oral care. Inside each data frame includes 30 products
and its prices, description, ratings, and reviews. All data are extracted as a 
character data type. The prices provide the cost of the products while the 
description summarizes the products key features. Moreover the ratings show how 
satisfied the customers were with the product and the reviews provide opinions 
of customers.

7. What will be your use case for the data you have extracted?
In this use case, we’ll explore pricing patterns across Amazon product 
categories using R. We’ll group and average prices for categories like Makeup, 
Skincare, and Hair Care, then create a bar graph to compare averages visually. 
