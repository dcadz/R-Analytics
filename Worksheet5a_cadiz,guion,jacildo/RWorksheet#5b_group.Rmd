...
```
1. Select 5 categories from Amazon and select 30 products from each category. Out of the 30 products, pick 10 products and extract 20 reviews in each one which includes:
reviewer, date, individual rating, text review, title of review, and verified purchase.
```{r}
library(rvest)
library(httr)
library(dplyr)
...
```
2. Out of the 30 products, pick 10 products and extract 20 reviews in each one 
which includes: reviewer, date, individual rating, text review, 
title of review, and verified purchase.
